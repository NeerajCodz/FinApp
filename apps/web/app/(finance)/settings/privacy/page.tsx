    ...
    <div className="finance-page">
      <header className="finance-page-heading">
        ...
        <Link className="finance-secondary-action" href="/settings">
          <ArrowRight size={15} aria-hidden="true" /> Settings
        </Link>
      </header>
      ...
      <Card className="finance-settings-card">
        ...
        <p>
          The optional passkey screen lock gates the interface only. It is origin and
          browser-profile scoped and does not provide the native SQLCipher or SecureStore guarantee.
        </p>
        <Link className="finance-inline-link" href="/privacy">
          Read the full privacy notes <ArrowRight size={15} aria-hidden="true" />
        </Link>
      </Card>
      ...
      <Card className="finance-settings-card">
        ...
        <Link className="finance-secondary-action" href="/settings">
          <Download size={15} aria-hidden="true" /> Open export controls
        </Link>
      </Card>
