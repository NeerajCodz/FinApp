    ...
    >
      ...
      >
        ...
        <View style={{ gap: 10 }}>
              ...
              return (
                ...
                >
                  <Text style={{ color: chosen ? tokens.split : tokens.foreground }}>
                    {String(item.name ?? 'Unnamed group')}
                  </Text>
          ...
          <Button variant="outline" onPress={() => router.push('/group/new' as never)}>
            Create a group
          </Button>
        </View>
              ...
              {compatibleAccounts.map((item) => {
                ...
                return (
                  <Pressable
                    key={id}
                    accessibilityRole="radio"
                    accessibilityLabel={displayAccountName(String(item.name ?? 'Account'))}
                    accessibilityState={{ selected: chosen }}
                    ...
                    {selected && method !== 'equal' && (
                      <View style={{ gap: 4 }}>
                        ...
                        <Input
                          ...
                          onChangeText={(value) =>
                            setBasis((current) => ({ ...current, [member.userId]: value }))
                          }
                        />
                      </View>
                    )}
