...
const settings = [
  ...
  {
    label: 'Currency',
    description: 'Default currency and locale',
    icon: CurrencyDollar,
  ...
  {
    label: 'Security',
    description: 'App lock and session controls',
    icon: LockKey,
    route: '/settings/security',
  },
  {
    label: 'Privacy & export',
    description: 'Data access and CSV export',
    icon: ShieldCheck,
    ...
    >
            ...
            return (
              <React.Fragment key={item.label}>
                ...
                {index < settings.length - 1 && (
                  <View
                    style={{ height: 1, backgroundColor: tokens.borderSubtle, marginLeft: 61 }}
                  />
                )}
              </React.Fragment>
            );
      ...
      <Card variant="subtle" style={{ gap: 8 }}>
        ...
        <Text style={{ color: tokens.mutedForeground, lineHeight: 20 }}>
          A private ledger for clearer decisions, not more noise.
        </Text>
