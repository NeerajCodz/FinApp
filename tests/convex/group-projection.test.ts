...
import { projectGroupBalances } from '../../apps/mobile/lib/groupBalances';
...
describe('group balance projection', () => {
  it('joins local and cloud transaction IDs, keeps settlement direction, and excludes ineligible transactions', () => {
    const result = projectGroupBalances(
      ...
      [
        { transactionId: 'local-t', userId: 'alice', amountMinor: 300n },
        { transactionId: 'cloud-t', userId: 'bob', amountMinor: 701n },
      ],
      [
        {
          groupId: 'local-g',
